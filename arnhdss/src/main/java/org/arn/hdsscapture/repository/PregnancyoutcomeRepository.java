...
public interface PregnancyoutcomeRepository extends JpaRepository <Pregnancyoutcome, String> {
	...
	@Query(nativeQuery = true, value ="SELECT	h.uuid as uuid,ass_del,ass_del_other,b_place,h.chd_size as pregnancy_uuid,h.weig_hcard as father_uuid,conceptionDate,first_nb,TIMESTAMPDIFF(year,dob,CURDATE()) as first_rec,\r\n"
			...
			+ "outcomeDate, rec_anc,rec_ipt,compno as visit_uuid,weig_hcard,where_anc, where_anc_Other,who_anc,why_no_anc,numberOfLiveBirths,type as edtime,\r\n"
	...
	@Query(nativeQuery = true, value ="SELECT	h.uuid as uuid,ass_del,ass_del_other,b_place,h.chd_size as pregnancy_uuid,h.chd_weight as father_uuid,conceptionDate,first_nb,first_rec,\r\n"
