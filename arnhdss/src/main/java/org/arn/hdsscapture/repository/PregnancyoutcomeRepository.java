...
public interface PregnancyoutcomeRepository extends JpaRepository <Pregnancyoutcome, String> {
	...
	@Query(nativeQuery = true, value ="SELECT	a.uuid,ass_del,ass_del_other,b_place,h.chd_size as pregnancy_uuid,h.weig_hcard as father_uuid,conceptionDate,first_nb,TIMESTAMPDIFF(year,dob,CURDATE()) as first_rec,\r\n"
