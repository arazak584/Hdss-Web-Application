...
public interface InmigrationRepository extends JpaRepository <Inmigration, String> {
	...
	@Query(nativeQuery = true, value ="SELECT a.uuid,concat(b.firstName,' ',b.lastName,' ',COALESCE(otherName, '')) as residency_uuid, a.`status`, `comment`, approveDate,b.dob as sttime, a.edtime, livestock_yn, food_yn, farm_other, farm, cash_yn, cash_crops, \r\n"
