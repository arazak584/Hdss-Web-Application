...
//	List<Queries> Lag(@Param("query") String query);
	...
	@Query(nativeQuery = true, value = "SELECT b.extId as id,groupName as id1,f.compno as id5,a.insertDate as id2,deathDate as id3,concat(e.firstName,' ',e.lastName)id4,NULL as id6,NULL as id7,NULL as id8 FROM death as a INNER JOIN socialgroup as b ON a.individual_uuid=b.individual_uuid\r\n"
