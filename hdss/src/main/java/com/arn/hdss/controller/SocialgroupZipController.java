...
import com.arn.hdss.entity.Socialgroup;
import com.arn.hdss.repository.SocialgroupRepository;
import com.fasterxml.jackson.dataformat.csv.CsvMapper;
import com.fasterxml.jackson.dataformat.csv.CsvSchema;

@RestController
@RequestMapping("/api/zip/socialgroup")
public class SocialgroupZipController {
	...
	public ResponseEntity<byte[]> downloadData() throws IOException {
	  ...
	  zos.putNextEntry(new ZipEntry("socialgroup.csv"));
	  ...
	  headers.setContentDispositionFormData("attachment", "socialgroup.zip");
